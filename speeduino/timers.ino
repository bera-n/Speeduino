  ...
  if (loopSec == 1000)
  {
    ...
    if(configPage2.flexEnabled == true)
    {
      if(flexCounter < 50)
      {
        ...
        currentStatus.ethanolPct_fuel = flexFallbackPct; //TODO: Should there be a margin eg below 40 pulses to set fallback value?
        flexCounter = 0;
      }
      else if (flexCounter > 151) //1 pulse buffer
      {
        ...
        if(flexCounter < 169)
        {
          ...
          currentStatus.ethanolPct_fuel = currentStatus.ethanolPct;
          flexCounter = 0;
        }
        else
        {
          ...
          currentStatus.ethanolPct_fuel = flexFallbackPct; // Set to default value
          flexCounter = 0;
        }
      }
      else
      ...
      if (currentStatus.ethanolPct_fuel == 1) { currentStatus.ethanolPct_fuel = 0; }
